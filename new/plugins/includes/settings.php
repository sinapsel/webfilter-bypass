...
$CONFIG['options']['encodePage'] = array(
   'title'   => 'Encode Page',
   'desc'    => 'Use when cannot bypass filters to encode the page at server and decode at you with JS',
   'default' => false,
   'force'   => false
);
...
$CONFIG['options']['allowCookies'] = array(
   'title'   => 'Allow Cookies',
   'desc'    => 'Cookies may be required on interactive websites',
   'default' => true,
   'force'   => false
);
...
$CONFIG['options']['stripJS'] = array(
   ...
   'desc'    => 'Remove scripts to speed up the page loading and level up your privacy',
   'default' => false,
   'force'   => false
);
...
$CONFIG['options']['stripObjects'] = array(
   ...
   'desc'    => 'No iframes, flash, java applets and etc',
   'default' => true,
   'force'   => false
);
